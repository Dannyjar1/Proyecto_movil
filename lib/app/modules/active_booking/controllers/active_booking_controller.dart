...
import 'package:reserva_de_canchas/app/data/service/user_service.dart';
import 'package:reserva_de_canchas/app/modules/all_venue/controllers/all_venue_controller.dart';
...
class ActiveBookingController extends GetxController with StateMixin {
  ...
  void handleCancelReservation(String transactionId) {
    Get.defaultDialog(
      ...
      middleText: 'Estás seguro de cancelar esta reservación?',
