...
import 'package:reserva_de_canchas/app/data/model/reservation/schedule_request.dart';
import 'package:reserva_de_canchas/app/data/model/venue/venue_response.dart';
import 'package:reserva_de_canchas/app/data/service/reservation_service.dart';
import 'package:reserva_de_canchas/app/helper/formatted_price.dart';
import 'package:reserva_de_canchas/app/modules/booking_field/widgets/dialog_content.dart';
import 'package:reserva_de_canchas/app/modules/home/controllers/home_controller.dart';
...
class BookingFieldController extends GetxController {
  ...
  void createReservation() async {
    ...
    final dialogModel = DialogContentModel(
      ...
      pricePerHour: '${getFormattedPrice(infoVenue.pricePerHour)}',
